...
-- rowid = files.id. Таблица contentless, строки поддерживает приложение.

CREATE VIRTUAL TABLE files_fts USING fts5(
  orig_name,
  note,
  tags_flat,      -- все теги файла одной строкой
  text_content,   -- текст из pdf/docx/pptx и OCR со сканов
  content = '',
